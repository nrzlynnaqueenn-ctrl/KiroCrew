...
class TestGetObjectHeadBytes:
    def _run(self, body: bytes, meta: object, max_bytes: int = 1024):
        captured: dict = {}
        ...
        with mock.patch.object(storage, "_checked", side_effect=fake_checked):
            data, size = storage.get_object_head_bytes(
                "p", "us-east-1", "b", "drive", "a.txt", account="111122223333", max_bytes=max_bytes
            )
