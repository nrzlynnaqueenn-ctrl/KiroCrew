...
def test_forked_template_names_is_sorted():
    agent_state.set_fork_info("zed", forked_from="kirocrew", private_to="cz")
    agent_state.set_fork_info("abe", forked_from="kirocrew", private_to="ca")

    assert agent_state.forked_template_names() == ["abe", "zed"]
